        ...
        public ActionResult Index(string name)
        {
            ...
            else
            {
                switch (name.ToLowerInvariant())
                {
                    ...
                    case "sprox": s = "<!DOCTYPE html><html lang='ru'><head><meta charset='UTF-8'><title>Автор</title></head><body><h2>Sergey 'sprox' Proskuryakov</h2><p>Помогал писать клиент.</p><p>Какая-то инфа</p></body></html>"; break;
